...
namespace InstrumentsCtrl
{
    ...
    /// AMP SP_1U
    /// </summary>
    public sealed class SP_1U : IPower, IDisposable
    {
        private readonly TcpClient client = new();
        public string SN { get; set; }
        public DeviceType DeviceType { get; set; } = DeviceType.AMP;
        public DeviceModel DeviceModel { get; set; } = DeviceModel.SP_1U;
        ...
        public SP_1U(string addr, ushort p)
        {
            Address = addr;
            Port = p;
        }
